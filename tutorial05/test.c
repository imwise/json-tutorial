...
static void test_parse_array() {
	...
	EXPECT_EQ_INT(LEPT_PARSE_OK, lept_parse(&v, "[null , true , false , 123 , \"abc\" ]"));
	EXPECT_EQ_SIZE_T(5, lept_get_array_size(&v));
	EXPECT_EQ_INT(LEPT_NULL, lept_get_array_element(&v, 0)->type);
	EXPECT_EQ_INT(LEPT_TRUE, lept_get_array_element(&v, 1)->type);
	EXPECT_EQ_INT(LEPT_FALSE, lept_get_array_element(&v, 2)->type);
	...
	//EXPECT_EQ_DOUBLE(NULL, lept_get_number(lept_get_array_element(lept_get_array_element(&v, 0), 0)));

	EXPECT_EQ_DOUBLE(0, lept_get_number(lept_get_array_element(lept_get_array_element(&v, 1), 0)));

	EXPECT_EQ_DOUBLE(0, lept_get_number(lept_get_array_element(lept_get_array_element(&v, 2), 0)));
